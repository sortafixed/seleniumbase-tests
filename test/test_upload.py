...
class UploadTest(BaseCase):
    def test_visible_upload(self):
        ...
        # get file path
        file_path = './data/biden.png'

        # upload file
        self.choose_file("#file-upload", file_path)  # id so pass in "#" sign
    ...
    def test_hidden_upload(self):
        ...
        # upload file
        self.choose_file("#upfile_1", file_path)  # id so pass in "#" sign

        # click the upload button
        self.click("#upload_1")

        # assert file uploaded text
        self.assert_text("File biden.png uploaded successfully", "#wfu_messageblock_header_1_label_1")
