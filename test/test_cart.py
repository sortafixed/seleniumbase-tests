...
class CartTest(CartPage):
    ...
    def test_add_to_cart(self):
        ...
        # time.sleep(5)  # Bad Practice wastes time
        ...
        # assert subtotal to be different than original subtotal
        updated_text = self.get_text(self.subtotal_text)
        print(updated_text)
        self.assertNotEqual(text, updated_text)
        self.assert_text('$240.00', self.subtotal_text)
